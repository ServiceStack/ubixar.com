...
public class ConfigureAiChat : IHostingStartup
{
    public void Configure(IWebHostBuilder builder) => builder
        .ConfigureServices((context, services) => {
            var providers = context.Configuration.GetSection("Providers");
            ...
            services.AddPlugin(new ChatFeature {
                ...
                Mcp = {
                 ...
                 Variables = {
                    ...
                    ["MISTRAL_API_KEY"] = providers["MISTRAL_API_KEY"],
                    ["CODESTRAL_API_KEY"] = providers["CODESTRAL_API_KEY"],
                    ["GROQ_API_KEY"] = providers["GROQ_API_KEY"],
                    ["OPENROUTER_API_KEY"] = providers["OPENROUTER_API_KEY"],
                    ["OPENROUTER_FREE_API_KEY"] = providers["OPENROUTER_FREE_API_KEY"],
                    ["XAI_API_KEY"] = providers["XAI_API_KEY"],
                    ["DASHSCOPE_API_KEY"] = providers["DASHSCOPE_API_KEY"],
                    ["ZAI_API_KEY"] = providers["ZAI_API_KEY"],
                    ["ZHIPU_API_KEY"] = providers["ZHIPU_API_KEY"],
                    ["ZAI_API_KEY_OKAI"] = providers["ZAI_API_KEY_OKAI"],
                    ["MINIMAX_API_KEY"] = providers["MINIMAX_API_KEY"],
                    ["CHUTES_API_KEY"] = providers["CHUTES_API_KEY"],
                    ["CEREBRAS_API_KEY"] = providers["CEREBRAS_API_KEY"],
                    ["FIREWORKS_API_KEY"] = providers["FIREWORKS_API_KEY"],
                },
                Setup = (ctx => {
