...
export class OpenAiUsage {
    /** @param {{completion_tokens?:number,prompt_tokens?:number,total_tokens?:number,completion_tokens_details?:OpenAiCompletionUsage,prompt_tokens_details?:OpenAiPromptUsage}} [init] */
    constructor(init) { Object.assign(this, init) }
    /**
     * @type {number}
    ...
    /**
     * @type {?OpenAiPromptUsage}
     * @description Breakdown of tokens used in the prompt. */
    prompt_tokens_details;
}
export class OpenAiChatResponse {
    /** @param {{id?:string,choices?:Choice[],created?:number,model?:string,system_fingerprint?:string,object?:string,service_tier?:string,usage?:OpenAiUsage,metadata?:{ [index:string]: string; },responseStatus?:ResponseStatus}} [init] */
    constructor(init) { Object.assign(this, init) }
    /**
     * @type {string}
...
export class OpenAiMessage {
    /** @param {{content?:Object,images?:string[],role?:string,name?:string,tool_calls?:ToolCall[],tool_call_id?:string}} [init] */
    constructor(init) { Object.assign(this, init) }
    /**
     * @type {Object}
     * @description The contents of the message. */
...
export class ChatCompletion {
    /** @param {{messages?:OpenAiMessage[],model?:string,audio?:OpenAiChatAudio,frequency_penalty?:number,logit_bias?:{ [index:number]: number; },logprobs?:boolean,max_completion_tokens?:number,metadata?:{ [index:string]: string; },modalities?:string[],n?:number,parallel_tool_calls?:boolean,presence_penalty?:number,prompt_cache_key?:string,reasoning_effort?:string,response_format?:OpenAiResponseFormat,safety_identifier?:string,seed?:number,service_tier?:string,stop?:string[],store?:boolean,stream?:boolean,temperature?:number,tools?:OpenAiTools[],top_logprobs?:number,top_p?:number,verbosity?:string}} [init] */
    constructor(init) { Object.assign(this, init) }
    /**
     * @type {OpenAiMessage[]}
...
export class RegisterExternalUser {
    /** @param {{userName?:string,email?:string}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    userName;
    /** @type {string} */
...
export class CompleteChatCompletion extends OpenAiChatResponse {
    /** @param {{refId?:number,id?:string,choices?:Choice[],created?:number,model?:string,system_fingerprint?:string,object?:string,service_tier?:string,usage?:OpenAiUsage,metadata?:{ [index:string]: string; },responseStatus?:ResponseStatus}} [init] */
    constructor(init) { super(init); Object.assign(this, init) }
    /** @type {number} */
    refId;
