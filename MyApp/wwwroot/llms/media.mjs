                        ...
                        <div class="p-6 rounded-2xl border" :class="[$styles.card]">
                            ...
                            <div class="space-y-6">
                                ...
                                <div v-if="parsedMedia.prompt">
                                    ...
                                    <div class="bg-gray-100 dark:bg-gray-900/50 p-3.5 rounded-xl border border-gray-200 dark:border-gray-800 text-xs font-mono text-gray-700 dark:text-gray-300 leading-relaxed max-h-48 overflow-y-auto custom-scrollbar select-all" :class="[$styles.borderInput]">
                                        {{ parsedMedia.prompt }}
                                    </div>
                                </div>
