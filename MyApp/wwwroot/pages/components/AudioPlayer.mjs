import { ref, computed, nextTick, shallowRef, onMounted, onUnmounted, watch } from "vue"
...
const AudioPlayer = {
    ...
    template:`
      <div v-if="src" :class="clsFilter ? clsFilter(v.cls) : v.cls">
        ...
        <audio ref="refPlayer"
               @play="onPlay()" @pause="onPause()" :autoplay="autoPlay"
