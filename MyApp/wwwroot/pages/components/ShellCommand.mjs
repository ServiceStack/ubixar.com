...
export default {
    ...
    <div class="flex ml-2 w-full justify-between cursor-pointer" @click="copyText">
      <div>
          <span>$ </span>
    ...
    <div v-if="successText" class="absolute right-3 -mr-28 -mt-2.5 rounded-md bg-green-50 dark:bg-green-900 p-3">
        <div class="flex">
            <div class="flex-shrink-0">
                <svg class="size-5 text-green-400 dark:text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
