...
/** @typedef {'Image'|'Video'|'Audio'|'Speech'|'Animation'|'Text'|'Binary'} */
export var AssetType;
(function (AssetType) {
    AssetType["Image"] = "Image"
    AssetType["Video"] = "Video"
    AssetType["Audio"] = "Audio"
    AssetType["Speech"] = "Speech"
...
export class UserPrefs {
    /** @param {{lastReadNotificationId?:number,lastReadAchievementId?:number,avatars?:{ [index:string]: string; }}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {number} */
...
export class ThreadReactionInfo {
    /** @param {{id?:number,threadId?:number,reaction?:Reaction}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {number} */
    id;
    /** @type {number} */
...
export class ThreadInfo {
    /** @param {{managedThreadId?:number,name?:string,state?:string,totalProcessorTime?:string}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {number} */
    managedThreadId;
    /** @type {?string} */
...
export class ImageData {
    /** @param {{b64_json?:string,media_type?:string}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    b64_json;
    /** @type {string} */
...
export class ImageTokenDetails {
    /** @param {{cached_tokens?:number,cache_write_tokens?:number,audio_tokens?:number,video_tokens?:number}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {number} */
    cached_tokens;
    /** @type {number} */
...
export class ImageCostDetails {
    /** @param {{upstream_inference_cost?:number,upstream_inference_prompt_cost?:number,upstream_inference_completions_cost?:number}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {number} */
...
export class ImageCompletionTokensDetails {
    /** @param {{reasoning_tokens?:number,image_tokens?:number}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {number} */
    reasoning_tokens;
    /** @type {number} */
...
export class ImageUsage {
    /** @param {{prompt_tokens?:number,completion_tokens?:number,total_tokens?:number,cost?:number,is_byok?:boolean,prompt_tokens_details?:ImageTokenDetails,cost_details?:ImageCostDetails,completion_tokens_details?:ImageCompletionTokensDetails}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {number} */
    prompt_tokens;
    /** @type {number} */
    ...
    prompt_tokens_details;
    /** @type {ImageCostDetails} */
    cost_details;
    /** @type {ImageCompletionTokensDetails} */
    completion_tokens_details;
}
...
export class GetPendingArtifactTasksResponse {
    ...
    missingArtifacts = [];
    /** @type {number[]} */
    existingCaptionArtifacts = [];
    /** @type {number[]} */
    existingDescribeArtifacts = [];
    /** @type {number[]} */
    requeueCaptionArtifacts = [];
    /** @type {number[]} */
    requeueDescribeArtifacts = [];
    /** @type {?ResponseStatus} */
    responseStatus;
}
...
export class GetAiChatResponse {
    /** @param {{result?:string,response?:ChatResponse,responseStatus?:ResponseStatus}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    result;
    /** @type {?ChatResponse} */
...
export class AppInfoResponse {
    /** @param {{processId?:number,startTime?:string,uptime?:string,workingSetBytes?:number,privateMemoryBytes?:number,managedMemoryBytes?:number,gcTotalAllocatedBytes?:number,gcGen0Collections?:number,gcGen1Collections?:number,gcGen2Collections?:number,totalProcessorTime?:string,userProcessorTime?:string,cpuUsagePercentApprox?:number,threadCount?:number,threads?:ThreadInfo[],pgTotalConnections?:number,pgActiveConnections?:number,pgIdleConnections?:number,pgIdleInTransaction?:number,pgWaitingConnections?:number,poolMaxSize?:number,poolMinSize?:number,pooling?:boolean,responseStatus?:ResponseStatus}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {number} */
    processId;
    /** @type {string} */
...
export class GetAppDataResponse {
    /** @param {{assetCount?:number,workflowCount?:number,agentEventCounts?:{ [index:string]: number; },agents?:AgentInfo[],defaultGatewayNodes?:string[],responseStatus?:ResponseStatus}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {number} */
    assetCount;
    /** @type {number} */
...
export class GenerateImageResponse {
    /** @param {{created?:number,data?:ImageData[],usage?:ImageUsage,responseStatus?:ResponseStatus}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {number} */
    created;
    /** @type {ImageData[]} */
...
export class PublishThreadResponse {
    /** @param {{publishedUrl?:string,responseStatus?:ResponseStatus}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    publishedUrl;
    /** @type {?ResponseStatus} */
...
export class PublishAvatarResponse {
    /** @param {{publishedUrl?:string,responseStatus?:ResponseStatus}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    publishedUrl;
...
export class PublishToCacheResponse {
    /** @param {{publishedUrls?:{ [index:string]: string; },responseStatus?:ResponseStatus}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {{ [index:string]: string; }} */
    publishedUrls = {};
    /** @type {?ResponseStatus} */
...
export class RegisterExternalUserResponse {
    /** @param {{apiKey?:string,userName?:string,userId?:string,responseStatus?:ResponseStatus}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    apiKey;
    /** @type {string} */
...
export class GenerateUsernamesResponse {
    /** @param {{suggestions?:string[],responseStatus?:ResponseStatus}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {?string[]} */
    suggestions;
    /** @type {?ResponseStatus} */
...
export class GetPendingArtifactTasks {
    constructor(init) { Object.assign(this, init) }
    getTypeName() { return 'GetPendingArtifactTasks' }
    getMethod() { return 'GET' }
    createResponse() { return new GetPendingArtifactTasksResponse() }
}
...
export class GetAiChat {
    /** @param {{id?:number,includeDetails?:boolean}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {?number} */
    id;
    /** @type {?boolean} */
...
export class AppInfo {
    constructor(init) { Object.assign(this, init) }
    getTypeName() { return 'AppInfo' }
    getMethod() { return 'GET' }
    createResponse() { return new AppInfoResponse() }
}
...
export class GenerateImage {
    /** @param {{model?:string,prompt?:string,resolution?:string,aspect_ratio?:string,n?:number,input_references?:AiImageContent[],seed?:boolean}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    model;
    /** @type {string} */
    ...
    /** @type {?boolean} */
    seed;
    getTypeName() { return 'GenerateImage' }
    getMethod() { return 'POST' }
    createResponse() { return new GenerateImageResponse() }
}
export class Hello {
    /** @param {{name?:string}} [init] */
    constructor(init) { Object.assign(this, init) }
...
export class PublishThread {
    /** @param {{id?:number,title?:string,model?:string,modelInfo?:{ [index:string]: Object; },messages?:Object[],createdAt?:string,updatedAt?:string,user?:string,systemPrompt?:string,modalities?:{ [index:string]: Object; },args?:{ [index:string]: Object; },tools?:{ [index:string]: Object; },cost?:number,inputTokens?:number,outputTokens?:number,stats?:{ [index:string]: Object; },provider?:string,providerModel?:string,startedAt?:string,completedAt?:string,error?:string,ref?:string,metadata?:{ [index:string]: Object; },toolHistory?:{ [index:string]: Object; },providerResponse?:{ [index:string]: Object; },contextTokens?:number,parentId?:number,status?:string}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {number} */
    id;
    /** @type {string} */
    ...
    /** @type {?string} */
    status;
    getTypeName() { return 'PublishThread' }
    getMethod() { return 'POST' }
    createResponse() { return new PublishThreadResponse() }
}
export class ViewPublishedThread {
    /** @param {{externalRef?:string}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    externalRef;
    getTypeName() { return 'ViewPublishedThread' }
    getMethod() { return 'GET' }
    createResponse() { return '' }
}
export class ViewPublishedMedia {
    /** @param {{externalRef?:string}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    externalRef;
    getTypeName() { return 'ViewPublishedMedia' }
    getMethod() { return 'GET' }
    createResponse() { return '' }
}
export class ViewPublishedMedias extends QueryBase {
    ...
    /** @type {AssetType} */
    type;
    getTypeName() { return 'ViewPublishedMedias' }
    getMethod() { return 'GET' }
    createResponse() { return '' }
}
...
export class PublishAvatar {
    ...
    /** @type {string} */
    profile;
    getTypeName() { return 'PublishAvatar' }
    getMethod() { return 'POST' }
    createResponse() { return new PublishAvatarResponse() }
}
export class GetPublishedAvatar {
    /** @param {{user?:string,profile?:string,theme?:string}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    user;
    /** @type {string} */
    ...
    /** @type {?string} */
    theme;
    getTypeName() { return 'GetPublishedAvatar' }
    getMethod() { return 'GET' }
    createResponse() { return new Blob() }
}
export class GetCacheFile {
    /** @param {{path?:string,download?:boolean}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    path;
    /** @type {?boolean} */
    download;
    getTypeName() { return 'GetCacheFile' }
    getMethod() { return 'GET' }
    createResponse() { return new Blob() }
}
export class PublishToCache {
    constructor(init) { Object.assign(this, init) }
    getTypeName() { return 'PublishToCache' }
    getMethod() { return 'POST' }
    createResponse() { return new PublishToCacheResponse() }
}
export class PublishMedia {
    constructor(init) { Object.assign(this, init) }
    getTypeName() { return 'PublishMedia' }
    getMethod() { return 'POST' }
    createResponse() { return new PublishMediaResponse() }
}
export class QueueMissingPublishedMedia {
    constructor(init) { Object.assign(this, init) }
    getTypeName() { return 'QueueMissingPublishedMedia' }
    getMethod() { return 'POST' }
    createResponse() { return new StringResponse() }
}
...
export class UpdatePublishedMedia {
    /** @param {{externalRef?:string,rating?:Rating,caption?:string,description?:string}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    externalRef;
    /** @type {?Rating} */
...
export class RegisterExternalUser {
    /** @param {{userName?:string,email?:string,displayName?:string,firstName?:string,lastName?:string}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    userName;
    /** @type {string} */
    ...
    /** @type {?string} */
    lastName;
    getTypeName() { return 'RegisterExternalUser' }
    getMethod() { return 'POST' }
    createResponse() { return new RegisterExternalUserResponse() }
}
export class GenerateUsernames {
    /** @param {{count?:number,userName?:string}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {?number} */
    count;
    /** @type {?string} */
    userName;
    getTypeName() { return 'GenerateUsernames' }
    getMethod() { return 'GET' }
    createResponse() { return new GenerateUsernamesResponse() }
}
export class CheckUsername {
    ...
    /** @type {string} */
    userName;
    getTypeName() { return 'CheckUsername' }
    getMethod() { return 'POST' }
    createResponse() { return new CheckUsernameResponse() }
}
export class GetChatCompletion {
    /** @param {{device?:string,models?:string[]}} [init] */
    constructor(init) { Object.assign(this, init) }
    /** @type {string} */
    device;
    /** @type {string[]} */
    models = [];
    getTypeName() { return 'GetChatCompletion' }
    getMethod() { return 'GET' }
    createResponse() { return new ChatCompletion() }
}
export class CompleteChatCompletion extends ChatResponse {
    /** @param {{refId?:number,id?:string,choices?:Choice[],created?:number,model?:string,system_fingerprint?:string,object?:string,service_tier?:string,usage?:AiUsage,provider?:string,metadata?:{ [index:string]: string; },responseStatus?:ResponseStatus}} [init] */
    constructor(init) { super(init); Object.assign(this, init) }
    /** @type {number} */
    refId;
    getTypeName() { return 'CompleteChatCompletion' }
    getMethod() { return 'POST' }
    createResponse() { return new EmptyResponse() }
}
...
export class QueryThreadReactions extends QueryDb_1 {
    /** @param {{threadId?:number,skip?:number,take?:number,orderBy?:string,orderByDesc?:string,include?:string,fields?:string,meta?:{ [index:string]: string; }}} [init] */
    constructor(init) { super(init); Object.assign(this, init) }
    /** @type {?number} */
    threadId;
    getTypeName() { return 'QueryThreadReactions' }
    getMethod() { return 'GET' }
    createResponse() { return new QueryResponse() }
}
