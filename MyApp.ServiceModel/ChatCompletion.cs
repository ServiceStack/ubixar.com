...
public abstract class AiContent
{
    ...
    public static AiTextContent Text(string text) => new() { Type = "text", Text = text };
    public static AiImageContent Image(string url) => new() { Type = "image_url", ImageUrl = new AiImageUrl { Url = url } };
    public static AiAudioContent Audio(string data, string format) => new() { Type = "input_audio", InputAudio = new AiInputAudio { Data = data, Format = format } };
    public static AiFileContent File(string fileData, string filename, string? fileId = null) => new() { Type = "file", File = new AiFile { FileData = fileData, Filename = filename, FileId = fileId } };
}
